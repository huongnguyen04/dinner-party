...
const HomeView = ({ user, logout }) => {
  const [makePartyView, setMakePartyView] = useState(false);
  ...
  return (
    ...
    {!makePartyView &&
      <FlexContainer>
        <PartiesContainer>
          ...
          <button onClick={() => setMakePartyView(true)}>New Party</button>
        </PartiesContainer>
    ...
    {makePartyView &&
      <>
      <PartyOverview theme={theme} setTheme={setTheme} host={host} setHost={setHost} date={date} setDate={setDate} generateMenu={generateMenu} sendPartyOverviewDetails={sendPartyOverviewDetails} watch={watch} setWatch={setWatch} logout={logout} formatInput={formatInput} setMakePartyView={setMakePartyView} />
        <StyledContainer>
          <StyledMenu>
